import fs from 'fs';
import type { ResponseLike } from 'phoenixforgeai/internal/to-file';
import { toFile } from 'phoenixforgeai/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('phoenixforgeai/core/uploads');
    await expect(
